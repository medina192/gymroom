...
/*
  useEffect(() => {
    ...
    const currentTime = parseInt(currentExercise.time_minutes) + currentExercise.time_seconds/100;
          ...
          <View style={styles.mainContainer}>
              {
                ...
                (
                  <Text>Ya has completado esta rutina</Text>
                )
                :
                (
                  <Text>No has completado esta rutina aún</Text>
                )
                */
              }
